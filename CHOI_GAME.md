...
3. Bấm **B** xem túi, mở cửa hàng để mua hạt, thú, thịt sống, xẻng/kiếm/rìu, khối xây hoặc bộ chuồng tự đặt. Hạt táo mua về nằm trong túi; kéo hạt lên hotbar rồi chuột phải trên đất vườn để trồng. Minimap góc phải cho thấy việc cần làm.
...
**Chỉ nút Lưu game trong menu Esc ghi tiến độ.** Thoát không tự lưu. Chế độ sáng tạo dùng bản sao trong bộ nhớ, LV99, bật bay và mở cả hai map; rời chế độ sẽ bỏ toàn bộ thay đổi thử nghiệm. Bản lưu v13 vẫn đọc được v2–v12. Đường dẫn bản lưu Windows: `%USERPROFILE%\AppData\LocalLow\Nong Trai Studio\Nong Trai - First Harvest\farm-manual-save.json`.
