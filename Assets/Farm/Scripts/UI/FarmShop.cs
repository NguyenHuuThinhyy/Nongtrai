...
namespace NongTrai
{
    public sealed class FarmShop : MonoBehaviour
    {
        ...
        readonly int[] prices={20,40,75,220,120,150,60,400,150,60,100,120,180,110,55,50,45,65,80,70,100,60,45,95};
        readonly string[] names={"5 hạt lúa mì","5 hạt cà chua","5 hạt đậu nành","Bò","Heo","Cừu","Gà","Chuồng gà thứ hai (5 chỗ)","Cây táo","5 khối đá","5 khối gạch","3 khối kính","3 khối kim loại","5 khối gỗ","5 khối cỏ","10 thức ăn","1 hạt cây gỗ","2 bậc gỗ","1 đuốc","3 hàng rào","2 ván cầu","2 cám dinh dưỡng","3 phân bón","1 bánh táo"};
        readonly int[] icons={0,1,2,50,51,52,53,42,54,31,32,33,34,30,35,17,54,40,41,42,43,46,47,44};
        void Start()
        {
            ...
            Button("◀ Trang trước",new Vector2(35,-545),()=>ShowPage((currentPage+2)%3));
            Button("Trang sau ▶",new Vector2(510,-545),()=>ShowPage((currentPage+1)%3));
        ...
        { currentPage=Mathf.Clamp(page,0,2);
          pageLabel.text=new[]{"TRANG 1/3 • HẠT GIỐNG VÀ VẬT NUÔI","TRANG 2/3 • CÂY, KHỐI XÂY VÀ THỨC ĂN","TRANG 3/3 • TRANG TRÍ, THỨC ĂN VÀ PHÂN BÓN"}[currentPage];
