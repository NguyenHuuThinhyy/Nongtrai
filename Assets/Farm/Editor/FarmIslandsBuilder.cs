...
namespace NongTrai.Editor
{
    public static partial class FarmProjectBuilder
    {
        static void BuildIslands(Transform parent)
        {
            ...
            Portal(parent,new Vector3(200,1.5f,-23),0,"Nông trại",gold);
            Sign(parent,new Vector3(204,0,-20),"KHÁM PHÁ","Giữ chuột trái đào khối. G xây dựng, Tab về nông trại. Đào 30 khối mở lò nung.");
