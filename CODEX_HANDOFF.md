...
- Sửa tiếp vùng tưới: vòng bán kính 6m là dải phẳng mảnh sát mặt ruộng, không còn thanh tia thẳng hay vòng dày nổi. Khi trạm/vòi hoạt động, 96 giọt nước xanh bay từ tay quay xuống mặt đất và 24 điểm bắn tóe xuất hiện nơi nước rơi. Smoke kiểm tra vòng, particle và giọt đang hoạt động; `Builds/Windows/irrigation-preview.png` và `irrigation-eye-preview.png` là ảnh kiểm tra trực quan.
