...
**Dữ liệu JSON:** `Assets/StreamingAssets/recipes.json` chứa 11 công thức máy, gồm máy ủ phân và bốn thức ăn theo loài; `Assets/StreamingAssets/crafting.json` chứa 18 công thức ghép tức thì. Mã hàng trong `FarmInventory.cs` từ 0 đến 55, gồm ba giống ruộng mới, lê, đào, việt quất và thức ăn vật nuôi. Bản lưu v13 giữ loại cây, vòi phun đặt được, dụng cụ, chuồng, máu/đói, đơn hàng và thời tiết; đọc được bản v2–v12.
...
Map khám phá tải/gỡ từng chunk 16×16 m quanh người chơi. Cây táo tròn ở khu khám phá cũ đã được loại bỏ; cây ăn quả được trồng trong vườn nông trại. Bản lưu v13 giữ seed, ô đã đào, túi đồ, thú hoang, kho/rương và tiến độ cả hai map. Chỉ bấm Lưu game mới ghi tiến độ.
